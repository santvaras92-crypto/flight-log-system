  ...
  return (
    <div className={`min-h-screen ${palette.bg} -mx-6 -my-8 px-4 sm:px-6 py-6 sm:py-8`}>
      ...
      <nav className="mb-6 sm:mb-8 flex flex-wrap gap-2 bg-white/90 backdrop-blur-sm p-2 rounded-xl border border-slate-200 shadow-sm">
        ...
        <a
          href="/admin/deposits"
          className="flex-1 min-w-[80px] px-3 sm:px-6 py-3 sm:py-4 rounded-lg font-bold uppercase tracking-wide text-xs sm:text-sm transition-all flex items-center justify-center gap-2 text-yellow-700 hover:text-yellow-900 hover:bg-yellow-100 bg-yellow-50 border border-yellow-300"
        >
          <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
          </svg>
          <span className="hidden sm:inline">Corregir Depósito</span>
        </a>
        {/* ...existing navigation tabs... */}
          t.href ? (
            <a
