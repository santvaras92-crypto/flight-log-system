    ...
    <div className={`min-h-screen ${palette.bg} -mx-6 -my-8 px-4 sm:px-6 py-6 sm:py-8`}>
      ...
      <nav className="mb-6 sm:mb-8 flex flex-wrap gap-2 bg-white/90 backdrop-blur-sm p-2 rounded-xl border border-slate-200 shadow-sm">
        {[
          ...
          { id: "fuel", label: "Fuel", icon: "M3 10h1l1-2h2V6h6v2h2l1 2h1a1 1 0 011 1v7a1 1 0 01-1 1h-1v1a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1H8v1a1 1 0 01-1 1H6a1 1 0 01-1-1v-1H4a1 1 0 01-1-1v-7a1 1 0 011-1zm2 7h2m8 0h2M9 6V4a1 1 0 011-1h4a1 1 0 011 1v2" },
