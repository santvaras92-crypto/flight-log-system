          ...
          <form id="registro-form" action={onFormSubmit} className="space-y-4">
            ...
            <div className="pt-2">
              <button 
                ...
                className="rounded-xl px-4 py-3 bg-blue-600 text-white w-full sm:w-auto disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-medium transition-all hover:bg-blue-700 active:scale-95"
              >
                {submitting && (
