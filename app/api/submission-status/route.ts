    ...
    return NextResponse.json({
      ...
      submission: {
        ...
        flight: submission.Flight ? {
          ...
          hobbs_inicio: submission.Flight.hobbs_inicio?.toNumber() ?? null,
          hobbs_fin: submission.Flight.hobbs_fin?.toNumber() ?? null,
          tach_inicio: submission.Flight.tach_inicio?.toNumber() ?? null,
          tach_fin: submission.Flight.tach_fin?.toNumber() ?? null,
          diff_hobbs: submission.Flight.diff_hobbs?.toNumber() ?? null,
          diff_tach: submission.Flight.diff_tach?.toNumber() ?? null,
          costo: submission.Flight.costo?.toNumber() ?? null,
