...
async function main() {
  // Find latest flight whose detalle contains "CAMBIO DE ACEITE" (case-insensitive)
  ...
  if (!flight) {
    console.log('No se encontró un vuelo con detalle "CAMBIO DE ACEITE".');
    return;
  }
  ...
  console.log('Último CAMBIO DE ACEITE:');
